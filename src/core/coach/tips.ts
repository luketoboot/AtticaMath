...
export const TIPS: readonly Tip[] = [
  ...
  { skillId: 'div.by.3', text: 'Threes: sum the digits. 78 → 15 → 6, a three. Shuffle the digits all you like — the sum never moves.' },
  { skillId: 'div.by.4', text: 'Fours: the hundreds are free. Judge the last two digits — halve twice, whole both times. 316 → 16 → 8 → 4.' },
  { skillId: 'div.by.7', text: 'Sevens have no digit trick. Anchor on 70 and walk: 84 → 70, 77, 84 — lands. 82 overshoots. The walk is the answer.' },
  { skillId: 'div.by.11', text: 'Elevens: add, subtract, alternate. 253 → 2−5+3 is 0 — an eleven. Land on 0 or 11 and it divides.' },
